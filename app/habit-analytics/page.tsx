...
/**
 * Combined Habit Analytics & Performance Dashboard
 * 
 * Displays:
 * - Performance Metrics (completion rate, streaks, goals)
    ...
    <ProtectedRoute>
      <main className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-3 sm:px-4 md:px-6 py-3 sm:py-6">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-start gap-2 sm:gap-3 mb-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Track habits, monitor performance, and identify trends
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8 animate-fade-in">
            {[
          ...
          {activeTab === 'performance' && (
            <div className="space-y-6 animate-fade-in">
              ...
              {/* Top Performing Habits */}
              <div className="glass backdrop-blur-xl bg-white/70 dark:bg-gray-800/70 rounded-xl p-6 border border-blue-200/50 dark:border-blue-700/50">
                <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">🏆 Top Performing Habits</h2>
                <div className="space-y-3">
          ...
          {activeTab === 'daily' && (
            <div className="space-y-8 animate-fade-in">
              <div className="glass backdrop-blur-xl bg-white/70 dark:bg-gray-800/70 rounded-xl p-6 border border-blue-200/50 dark:border-blue-700/50">
                <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">📅 Last 7 Days</h2>
          ...
          {activeTab === 'weekly' && (
            <div className="space-y-8 animate-fade-in">
              <div className="glass backdrop-blur-xl bg-white/70 dark:bg-gray-800/70 rounded-xl p-6 border border-blue-200/50 dark:border-blue-700/50">
                <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">📆 Last 4 Weeks</h2>
          ...
          {activeTab === 'monthly' && (
            <div className="space-y-8 animate-fade-in">
              <div className="glass backdrop-blur-xl bg-white/70 dark:bg-gray-800/70 rounded-xl p-6 border border-blue-200/50 dark:border-blue-700/50">
                <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">📊 This Month</h2>
